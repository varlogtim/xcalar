...
BuildRequires:  gcc-c++
%if 0%{?rhel} && 0%{?rhel} <= 7
BuildRequires:  python2-devel python-rpm-macros python2-rpm-macros epel-rpm-macros
%else
BuildRequires:  python3-devel python-rpm-macros python3-rpm-macros epel-rpm-macros
%endif
...
# First install (as opposed to upgrade)
if [ "$1" = 1 ]; then
  ln -sfn ../../bin/ninja-build /usr/local/bin/ninja
fi
...
%changelog
* Sun Mar 25 2018 Amit Bakshi <abakshi@xcalar.com>	- 1.8.2-2
- Bump version number

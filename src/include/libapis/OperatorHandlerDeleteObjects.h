...
#ifndef _OPERATORHANDLER_DELETEOBJECTS_H
#define _OPERATORHANDLER_DELETEOBJECTS_H

#include "libapis/OperatorHandler.h"

struct XcalarApiDagNodeNamePatternInput;

class OperatorHandlerDeleteObjects final : public OperatorHandler
{
  public:
    OperatorHandlerDeleteObjects(XcalarApis api);
    virtual ~OperatorHandlerDeleteObjects(){};
  ...
  private:
    static constexpr const char *moduleName =
        "libapis::operatorHandler::deleteObjects";
...
#endif  // _OPERATORHANDLER_DELETEOBJECTS_H

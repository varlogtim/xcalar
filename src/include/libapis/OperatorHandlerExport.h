...
#ifndef _OPERATORHANDLER_EXPORT_H
#define _OPERATORHANDLER_EXPORT_H

#include "libapis/OperatorHandler.h"

struct XcalarApiExportInput;

class OperatorHandlerExport final : public OperatorHandler
{
  public:
    OperatorHandlerExport(XcalarApis api);
    virtual ~OperatorHandlerExport(){};
  ...
  private:
    static constexpr const char *moduleName =
        "libapis::operatorHandler::export";
    XcalarApiExportInput *input_;
...
#endif  // _OPERATORHANDLER_EXPORT_H

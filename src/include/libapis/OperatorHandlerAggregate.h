...
#ifndef _OPERATORHANDLER_AGGREGATE_H
#define _OPERATORHANDLER_AGGREGATE_H

#include "libapis/OperatorHandler.h"

struct XcalarApiAggregateInput;

class OperatorHandlerAggregate final : public OperatorHandler
{
  public:
    OperatorHandlerAggregate(XcalarApis api);
    virtual ~OperatorHandlerAggregate();
  ...
  private:
    static constexpr const char *moduleName =
        "libapis::operatorHandler::aggregate";
    XcalarApiAggregateInput *input_;
...
#endif  // _OPERATORHANDLER_AGGREGATE_H

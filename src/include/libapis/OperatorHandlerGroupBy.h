...
#ifndef _OPERATORHANDLER_GROUPBY_H
#define _OPERATORHANDLER_GROUPBY_H
...
class OperatorHandlerGroupBy final : public OperatorHandler
{
  public:
    OperatorHandlerGroupBy(XcalarApis api);
    virtual ~OperatorHandlerGroupBy();
  ...
  private:
    static constexpr const char *moduleName =
        "libapis::operatorHandler::groupBy";
    XcalarApiGroupByInput *input_;
    ...
    bool useEvalContextOptimization(XdbMeta *srcMeta);
...
#endif  // _OPERATORHANDLER_GROUPBY_H

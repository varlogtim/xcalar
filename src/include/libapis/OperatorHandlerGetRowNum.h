...
#ifndef _OPERATORHANDLER_GETROWNUM_H
#define _OPERATORHANDLER_GETROWNUM_H

#include "libapis/OperatorHandler.h"

struct XcalarApiGetRowNumInput;

class OperatorHandlerGetRowNum final : public OperatorHandler
{
  public:
    OperatorHandlerGetRowNum(XcalarApis api);
    virtual ~OperatorHandlerGetRowNum(){};
  ...
  private:
    static constexpr const char *moduleName =
        "libapis::operatorHandler::getRowNum";
    XcalarApiGetRowNumInput *input_;
...
#endif  // _OPERATORHANDLER_GETROWNUM_H

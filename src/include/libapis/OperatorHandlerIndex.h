...
#ifndef _OPERATORHANDLER_INDEX_H
#define _OPERATORHANDLER_INDEX_H

#include "libapis/ApiHandler.h"
#include "libapis/OperatorHandler.h"

class OperatorHandlerIndex final : public OperatorHandler
{
  public:
    OperatorHandlerIndex(XcalarApis api);
    virtual ~OperatorHandlerIndex(){};

    static void generatePrefixedKeyName(char *keyName);
  ...
  private:
    static constexpr const char *moduleName = "libapis::operatorHandler::index";
    XcalarApiIndexInput *input_;
    DagTypes::NodeId parentNodeId_ = DagTypes::InvalidDagNodeId;
    ...
    Status createDagNodeForTrackingDatasetRefCount(
        const char *datasetName,
        DagTypes::NodeId parentNodeId,
        XcalarApiUdfContainer *udfContainer);
    Status trackExistingDatasetNode(DagTypes::NodeId nodeId);
};

#endif  // _OPERATORHANDLER_INDEX_H

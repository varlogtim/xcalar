...
#ifndef _OPERATORHANDLER_SYNTHESIZE_H
#define _OPERATORHANDLER_SYNTHESIZE_H
...
class OperatorHandlerSynthesize final : public OperatorHandler
{
  public:
    OperatorHandlerSynthesize(XcalarApis api);
    ~OperatorHandlerSynthesize();
  ...
  private:
    ...
    XcalarApiSynthesizeInput *input_ = NULL;
    bool srcXdbReused_ = false;
    DatasetRefHandle dsRefHandle_;
    bool dsRefHandleInit_ = false;

    bool checkIfSrcXdbCompatibleForReuse(XdbId srcXdbId);
...
#endif  // _OPERATORHANDLER_SYNTHESIZE_H
